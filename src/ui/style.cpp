...
void Style::SetCustomTheme(float* bgColor, float* textColor, float* accentColor) {
    ...
    style.Colors[ImGuiCol_Button] = ImVec4(accentColor[0], accentColor[1], accentColor[2], accentColor[3]);
    style.Colors[ImGuiCol_ButtonHovered] = ImVec4(accentColor[0] * 1.2f, accentColor[1] * 1.2f, accentColor[2] * 1.2f, accentColor[3]);
    style.Colors[ImGuiCol_ButtonActive] = ImVec4(accentColor[0] * 0.8f, accentColor[1] * 0.8f, accentColor[2] * 0.8f, accentColor[3]);
}
